...
namespace Colas.Clases.culebrita
{
    class CulebraConLista
    {
        ...
        private static bool MoverLaCulebrita(ColaConLista culebra, Point posiciónObjetivo, int longitudCulebra, Size screenSize)
        {
        ...
        {
            var punteo = 0;
            var velocidad = 100; //modificar estos valores y ver qué pasa //VELOCIDAD CON LA QUE SE MOVERÁ LA CULEBRA
